...
<html>
    ...
    <jsp:include page="../comunes/cabecero.jsp" />
        <form action="${pageContext.request.contextPath}/ServletProveedor?accion=modificar&id=${proveedor.id}"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="descripcion" required value="${proveedor.descripcion}">
                                    </div>
                                </div>
                            </div>
                        </div>
