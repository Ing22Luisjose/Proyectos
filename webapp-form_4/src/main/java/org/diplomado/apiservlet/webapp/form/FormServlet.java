...
public class FormServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        boolean habilitar =  req.getParameter("habilitar") !=null &&  req.getParameter("hablitar") .equals("on");
        ...
        if (email == null || email.contains("@")) {
            errores.put("email", "el email es requerido y debe tener un formato de correcto!");
        }
        if (pais == null || pais.equals("") || pais.equals(" ")) {
            errores.put("pais", "el pais es requerido!");
        }
        if (lenguajes == null || lenguajes.length == 0) {
            errores.put("lenguaje", "debe seleccionar al menos un tema!");
        }
